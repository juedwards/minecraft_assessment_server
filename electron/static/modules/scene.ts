...
// Scene utilities for the viewer

let _scene: any = null;
let _camera: any = null;
let _renderer: any = null;
let _controls: any = null;
let _groundMesh: any = null;
let _gridHelper: any = null;
let _axesHelper: any = null;

export function createScene(options: { showDefaultGround?: boolean; showGrid?: boolean; showAxes?: boolean } = {}) {
...
function _disposeMaterial(mat: any) {
    if (!mat) return;
...
export function removeDefaultground() {
    ...
    if (Array.isArray(_groundMesh.material)) {
        _groundMesh.material.forEach((m: any) => _disposeMaterial(m));
    } else {
